/*
  Fake Garda-style prop search system.
  For TV / film prop use only. No live data.

  Features:
  - Fixed 2011 clock/date
  - Desktop: Search with Enter, results with Arrow Up / Arrow Down / Enter
  - Mobile/tablet: tap result to open record
  - Works even if database.js is missing, because fallback fake data is included
*/

const PROP_DATE_TIME = "14/06/2011 09:42";
const SEARCH_PAGE = "gardasearch.html";
const RESULTS_PAGE = "results.html";
const RECORD_PAGE = "record.html";
